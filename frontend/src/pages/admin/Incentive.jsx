...
const Incentive = () => {
  ...
  const fetchIncentives = async () => {
    try {
      setLoading(true);
      const { data } = await API.get("/approvals/incentives", {
  ...
  const approveIncentive = async (id) => {
    ...
    setBusyId(id);
    try {
      const { data } = await API.put(`/approvals/${id}/approve-incentive`);
  ...
  const rejectIncentive = async (id) => {
    ...
    setBusyId(id);
    try {
      await API.put(`/approvals/${id}/reject-incentive`);
    ...
    <div className="approvals-page">
      <div className="page-header">
        <div>
          ...
          <p>
            Review bottom-line allocation requests raised when a customer deal is closed
          </p>
        </div>
      </div>
